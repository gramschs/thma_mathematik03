...
$\mathbf{A}^{-1}\cdot\mathbf{A}=\mathbf{A}^{-1}\cdot\mathbf{A}=\mathbf{E}$ gilt.
...
Zeile. Lässt sich der linke Block nicht zur Einheitsmatrix umformen, ist
$\mathbf{A}$ nicht invertierbar.
