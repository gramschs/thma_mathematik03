...
Wir betrachten zwei Massen, die über zwei Schraubenfedern hintereinander an
einer festen Wand befestigt sind. Die erste Feder verbindet die Wand mit Masse
1, die zweite Feder verbindet Masse 1 mit Masse 2. Greifen an den Massen Kräfte
an, verschieben sich die Massen so weit, bis die Federkräfte die äußeren Kräfte
ausgleichen. Solche Federketten sind mehr als ein Spielzeugmodell. In der
Finite-Elemente-Methode zerlegen wir ein Bauteil gedanklich in viele kleine
federnde Abschnitte und rechnen genau so.
