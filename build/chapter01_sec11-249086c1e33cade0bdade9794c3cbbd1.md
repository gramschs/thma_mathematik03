...
* Die Determinante einer Diagonalmatrix ist das Produkt der Elemente in der
  Diagonalen.
* Die Determinante einer einer unteren oder oberen Dreiecksmatrix ist das
  Produkt der Elemente in der Diagonalen.
...
* Vertauscht man zwei Zeilen (oder zwei Spalten), dann wechselt das Vorzeichen
  der Determinante.
* Addiert man das Vielfache einer anderen Zeile (oder Spalte) zu einer anderen
  Zeile (oder Spalte), dann ändert sich die Determinante nicht. Das kann man
