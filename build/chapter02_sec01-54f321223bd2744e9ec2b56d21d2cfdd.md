...
$$s\cdot\mathbf{A} = \begin{pmatrix} 2 & 4 \\ 0 & 6 \end{pmatrix} \Rightarrow
\left(s\cdot\mathbf{A}\right)^{\top} = \begin{pmatrix} 2 & 0 \\ 4 & 6 \end{pmatrix}.$$

Das stimmt mit

$$s\cdot\mathbf{A}^{\top} = 2\cdot\begin{pmatrix} 1 & 0 \\ 2 & 3 \end{pmatrix} =
\begin{pmatrix} 2 & 0 \\ 4 & 6 \end{pmatrix}$$
...
$$\mathbf{A}\cdot\mathbf{B} = \begin{pmatrix} 4 & 1 \\ 3 & 0 \end{pmatrix} \Rightarrow
\left(\mathbf{A}\cdot\mathbf{B}\right)^{\top} = \begin{pmatrix} 4 & 3 \\ 1 & 0 \end{pmatrix}.$$

Berechnen wir

$$\mathbf{B}^{\top}\cdot\mathbf{A}^{\top} = \begin{pmatrix} 4 & 3 \\ 1 & 0 \end{pmatrix},$$
...
$$\mathbf{A}^{\top}\cdot\mathbf{B}^{\top} = \begin{pmatrix} 2 & 1 \\ 7 & 2 \end{pmatrix},$$
