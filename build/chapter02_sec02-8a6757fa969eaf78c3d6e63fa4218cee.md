...
erzeugen wir mithilfe des Pivotelements $a_{11}=\boxed{1}$ eine Null unterhalb
davon in der ersten Spalte. Dazu ersetzen wir die dritte Zeile $Z_3$ durch $Z_3-
5 \cdot Z_1$:
...
Als nächstes nutzen wir das Pivotelement $\boxed{a_{22}=1}$, um in der zweiten Spalte
...
\begin{equation*}
\left(\begin{array}{ccc|ccc}
1 & \textcolor{red}{0} & -5 & 1 & -2 & 0 \\
0 & \boxed{1} & 4 & 0 & 1 & 0 \\
0 & \textcolor{red}{0} & 1 & -5 & 4 & 1 \\
\end{array}\right)
\end{equation*}

Zuletzt nutzen wir das Pivotelement $\boxed{a_{33}=1}$, um in der dritten Spalte
oberhalb Nullen zu erzeugen. Wir ersetzen dazu $Z_1$ durch $Z_1 + 5 \cdot Z_3$
und $Z_2$ durch $Z_2 - 4 \cdot Z_3$:

\begin{equation*}
\left(\begin{array}{ccc|ccc}
1 & 0 & \textcolor{red}{0} & -24 & 18 & 5 \\
0 & 1 & \textcolor{red}{0} & 20 & -15 & -4 \\
0 & 0 & \boxed{1} & -5 & 4 & 1 \\
\end{array}\right)
\end{equation*}
