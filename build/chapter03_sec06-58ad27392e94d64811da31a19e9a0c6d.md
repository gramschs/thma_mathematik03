...
aufgefasst als Matrix mit den Basisvektoren als Spalten.
...
$V = (\vec{v}_1, \ldots, \vec{v}_n)$ des $\mathbb{R}^n$, aufgefasst als Matrix
...
Der Basiswechsel berechnet den Koordinatenvektor $[\vec{a}]_V$ eines gegebenen
Vektors bezüglich einer neuen Basis durch Lösung des Gleichungssystems
$V \cdot [\vec{a}]_V = \vec{a}$.
