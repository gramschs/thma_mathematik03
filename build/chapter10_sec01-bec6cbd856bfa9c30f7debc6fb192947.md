...
eindeutig festzulegen: Wir geben die Position zum Zeitpunkt $t_0$ vor, und
die einzige Integrationskonstante ist bestimmt. Bei einer ODE 2. Ordnung
beschreibt die Gleichung die Beschleunigung des Systems, also die Änderung
der Änderungsrate. Um den weiteren Verlauf eindeutig vorherzusagen, müssen wir
sowohl die Anfangslage als auch die Anfangsgeschwindigkeit kennen. Diese zwei
Vorgaben legen genau die zwei freien Konstanten $C_1$ und $C_2$ in $y_h$ fest.
