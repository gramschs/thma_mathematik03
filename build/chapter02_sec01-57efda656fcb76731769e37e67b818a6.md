...
* [ ] Sie wissen, was eine **transponierte Matrix** ist und können zu einer
  gegebenen Matrix die transponierte Matrix berechnen, also **Transponieren**.
...
Stimmt, das liest sich wie zwei separate Einleitungen hintereinander. Der zweite Absatz wiederholt quasi, was der erste schon gesagt hat ("symmetrische Matrix" wird zweimal neu eingeführt), statt darauf aufzubauen.

Lösung: Der zweite Absatz sollte direkt an das Bohrungen-Beispiel anknüpfen und zur allgemeinen Definition überleiten, statt nochmal von vorne zu beginnen.
...
also spiegelsymmetrisch bezüglich der Hauptdiagonalen, wie es auch die
Abstandsmatrix $\mathbf{D}$ oben zeigt. Beispielsweise ist die folgende Matrix
symmetrisch:
