...
Nachgerechnet an unserem Beispiel ist $\mathbf{A}+\mathbf{B} = \begin{pmatrix} 3 & 3 \\ 1 & 3 \end{pmatrix}$
...
$$\mathbf{A}^{\top} = \begin{pmatrix} 1 & 0 \\ 2 & 3 \end{pmatrix}
\text{ und }
\mathbf{B}^{\top} = \begin{pmatrix} 2 & 1 \\ 1 & 0 \end{pmatrix},$$
