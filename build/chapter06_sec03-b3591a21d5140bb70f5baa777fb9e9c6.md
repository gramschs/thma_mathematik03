...
# Darstellung für drei Schrittweiten
for h in [5.0, 2.0, 0.5]:
    t, v = euler(h)
    plt.plot(t, v, label=f'Euler  h = {h} s')

plt.plot(t_ex, v_ex, 'k-',  label='Exakte Lösung')
plt.axhline(g / k, color='gray', linestyle='--', label='Grenzgeschwindigkeit')
