...
---
Verlauf der partikulären Lösung \(y_p(t) = 5 t e^{-t}\) im Resonanzfall aus Abschnitt 11.2 mit markiertem Maximum bei \(t = 1\) und \(y_p(1) = 5/e\). Der Faktor \(t\) führt zunächst zu einem Anwachsen der Auslenkung, bevor das Exponential \(e^{-t}\) dominiert und die Antwort wieder gegen null abklingen lässt.(Quelle: eigene Abbildung; Lizenz [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0))
```
