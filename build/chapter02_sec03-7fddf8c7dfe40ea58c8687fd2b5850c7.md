...
Als Nächstes verdoppeln wir die Matrix. Für $2 \cdot \mathbf{A} = \begin{pmatrix} 6 & -2 \\ -2 & 2 \end{pmatrix}$ ist $a \cdot d - c \cdot b = 12 -
4 = 8$, und wir erhalten
...
Mit diesen Regeln sparen wir uns ab jetzt die Formel. Für die Matrix
$\frac{1}{2} \cdot \mathbf{A}$ erhalten wir sofort $(\frac{1}{2} \cdot
\mathbf{A})^{-1} = 2 \cdot \mathbf{A}^{-1} = \begin{pmatrix} 1 & 1 \\ 1 & 3
\end{pmatrix}$. Die Probe bestätigt das Ergebnis:
...
hinzu. Das Produkt ist $\mathbf{A} \cdot \mathbf{B} = \begin{pmatrix} 3 & -4 \\
-1 & 2 \end{pmatrix}$, und mit $a \cdot d - c \cdot b = 6 - 4 = 2$ liefert die
Formel $(\mathbf{A} \cdot \mathbf{B})^{-1} = \frac{1}{2} \begin{pmatrix} 2 & 4 \\
