...
* [ ] Sie kennen die **Resonanzamplitude**
  ...
  warum sie für $\Omega \to \omega_0$ unbegrenzt wächst.
...
wächst $\hat{y}_p$ ohne Schranke. Das ist der Resonanzfall.
```
...
Amplituden sind endlich. In der Maschinendynamik nennt man diesen Betriebszustand
...
Im Maschinenbau wird die kritische Drehzahl entweder durch gezielte Dämpfung
entschärft oder durch konstruktive Maßnahmen so gelegt, dass der
Betriebsbereich sie weit verfehlt.
```
