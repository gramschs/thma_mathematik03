...
(1,0)T(1, 0)^T(1,0)T (in Metern), also direkt auf der positiven $x$-Achse, genau
1 m1\,\text{m}1m vom Gelenk entfernt. Wo befindet sich der Greifer nach der
Drehung?
Eine ebene Drehung um den Winkel φ\varphiφ um den Ursprung wird durch die
Rotationsmatrix
\begin{equation*}
\mathbf{R}(\varphi) =
\begin{pmatrix}
...
\end{pmatrix}
\end{equation*}
beschrieben. Für φ=30°\varphi = 30°φ=30° gilt cos⁡30°=32\cos 30° = \frac{\sqrt{3}}{2}cos30°=23​​ und
sin⁡30°=12\sin 30° = \frac{1}{2}sin30°=21​, also:
\begin{equation*}
\mathbf{R}(30°) =
\begin{pmatrix}
...
wie wir sie in Kapitel 2 für lineare Abbildungen eingeführt haben:
\begin{equation*}
...
\begin{pmatrix} \dfrac{\sqrt{3}}{2} \[8pt] \dfrac{1}{2} \end{pmatrix}
\approx
\begin{pmatrix} 0{,}87,\text{m} \ 0{,}50,\text{m} \end{pmatrix}.
\end{equation*}
Der Greifer befindet sich nach der Drehung bei etwa
(0,87 m, 0,50 m)T(0{,}87\,\text{m},\, 0{,}50\,\text{m})^T(0,87m,0,50m)T. Das ist ein Punkt im ersten
Quadranten, der den Winkel 30°30°30° mit der xxx-Achse einschließt. Wir prüfen
...
schauen wir genauer hin, was an der Matrix R(30°)\mathbf{R}(30°)R(30°) so besonders ist.
Wann nennen wir eine Matrix orthogonal?
Wir betrachten die beiden Spaltenvektoren von R(30°)\mathbf{R}(30°)R(30°):
\begin{equation*}
\vec{q}_1 = \begin{pmatrix} \dfrac{\sqrt{3}}{2} \[8pt] \dfrac{1}{2} \end{pmatrix},
\qquad
\vec{q}_2 = \begin{pmatrix} -\dfrac{1}{2} \[8pt] \dfrac{\sqrt{3}}{2} \end{pmatrix}.
\end{equation*}
