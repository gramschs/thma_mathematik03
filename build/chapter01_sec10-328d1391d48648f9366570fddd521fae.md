...
für eine fest gewählte Spalte $j$. Jedes Element $a_{ij}$ der gewählten Zeile
wird mit der Determinante seiner Untermatrix multipliziert. Das Vorzeichen
$(-1)^{i+j}$ wechselt schachbrettartig zwischen $+$ und $-$. Für eine $4\times
4$-Matrix sieht dieses Muster so aus:
...
für eine fest gewählte Zeile $i$.
